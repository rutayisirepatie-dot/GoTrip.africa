...
// Use test DB if available, otherwise fallback to main DB
const mongoURI = process.env.MONGODB_TEST_URI || process.env.MONGO_URI || 'mongodb://localhost:27017/adventure-hillbound';
